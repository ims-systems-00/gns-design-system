(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('reactstrap'), require('react/jsx-runtime'), require('react'), require('classnames'), require('prop-types'), require('react-table'), require('react-select'), require('react-select/creatable'), require('react-select/async'), require('react-dropzone'), require('react-datetime'), require('react-datetime/css/react-datetime.css'), require('swiper'), require('swiper/css'), require('swiper/css/pagination'), require('swiper/react'), require('react-circular-progressbar'), require('react-circular-progressbar/dist/styles.css'), require('react-modern-drawer'), require('react-modern-drawer/dist/index.css'), require('axios'), require('react-toastify'), require('yup')) :
  typeof define === 'function' && define.amd ? define(['exports', 'reactstrap', 'react/jsx-runtime', 'react', 'classnames', 'prop-types', 'react-table', 'react-select', 'react-select/creatable', 'react-select/async', 'react-dropzone', 'react-datetime', 'react-datetime/css/react-datetime.css', 'swiper', 'swiper/css', 'swiper/css/pagination', 'swiper/react', 'react-circular-progressbar', 'react-circular-progressbar/dist/styles.css', 'react-modern-drawer', 'react-modern-drawer/dist/index.css', 'axios', 'react-toastify', 'yup'], factory) :
  (global = global || self, factory(global.gnsUi = {}, global.reactstrap, global.jsxRuntime, global.react, global.classnames, global.propTypes, global.reactTable, global.reactSelect, global.CreatableSelect, global.AsyncSelect, global.reactDropzone, global.reactDatetime, null, global.swiper, null, null, global.react, global.reactCircularProgressbar, null, global.reactModernDrawer, null, global.axios, global.reactToastify, global.yup));
})(this, (function (exports, reactstrap, jsxRuntime, React, classNames, PropTypes, reactTable, ReactSelect, CreatableSelect, AsyncSelect, reactDropzone, Datetime, reactDatetime_css, swiper, css, pagination, react, reactCircularProgressbar, styles_css, Drawer, index_css, axios, reactToastify, yup) {
